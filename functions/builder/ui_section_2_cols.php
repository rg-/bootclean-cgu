...
*/
	...
	add_filter('wpbc/filter/acf/builder/flexible_content/layouts', 'WPBC_build__ui_section_2_cols',20,1);  
	
	function WPBC_build__ui_section_2_cols($layouts){ 

		$layout_name = 'ui_section_2_cols'; 

		$layout_label = '<i class="icon-badge"><span style="background-color:#b45541; "></span></i> 2 Cols A'; 
		...
		$content_sub_fields[] = WPBC_acf_make_gallery_field(array(
				'label' => __('Imágen/Galería','bootclean'),
