...
*/
	...
	add_filter('wpbc/filter/acf/builder/flexible_content/layouts', 'WPBC_build__ui_section_default',20,1);  
	
	function WPBC_build__ui_section_default($layouts){ 

		$layout_name = 'ui_section_default'; 

		$layout_label = '<i class="icon-badge"><span style="background-color:#b45541; "></span></i> 1 Col'; 
